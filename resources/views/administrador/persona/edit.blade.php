...
<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
  <div class="card-body" style="border-bottom: 1px solid #C0C0C0">
	...
	<div class="row">
	  <div class="col-md-6">
	      <h4 style="margin-top: 0px"><i class="fas fa-user-edit"></i> Editar Persona</h4>
	   </div>
	</div>
...
{!!Form::model($persona,['method'=>'PATCH','action'=>['Administrador\PersonaController@update',$persona[0]->nid_persona],'files'=>true,'class'=>'formcreate'])!!}
            {{Form::token()}}
   ...
   <div class="form-group row">
				...
				<div id="razonrow" >
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" placeholder="Razon social" name="cnombre" style="text-transform: uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" id="idrazon" value="{{$persona[0]->cnombre}}">
						</div>
					</div>
				</div>
				<?php }else{ ?>
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" placeholder="Nombre" name="cnombre" required="" style="text-transform: uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" id="idnombre" value="{{$persona[0]->cnombre}}">
					</div>
				</div>
				<div class="form-group row" id="paternorow">
					<label for="Nombre" class="col-sm-2 col-form-label">* Apellido paterno:</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" placeholder="Apellido paterno" name="cpaterno" required="" style="text-transform: uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" id="idapaterno" value="{{$persona[0]->capaterno}}">
					</div>
				</div>
				<div class="form-group row" id="maternorow">
					<label for="Nombre" class="col-sm-2 col-form-label">* Apellido materno:</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" placeholder="Apellido materno" name="cmaterno" required="" style="text-transform: uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" id="idamaterno" value="{{$persona[0]->camaterno}}">
					</div>
				</div>
				</div>
			...
			<?php }?>
				...
				<div class="form-group row">
					...
					<div class="col-sm-4">
						<input type="date" class="form-control" name="dfnacimento" required="" value="{{$persona[0]->dfnacimiento}}">
					</div>
					...
					<div class="col-sm-4">
						<input type="number" class="form-control" placeholder="Número de documento" name="numero_de_documento" onKeyPress="if(this.value.length==8) return false;" required="" onwheel="this.blur()" id="numerodoc" value="{{$persona[0]->cdocnro}}">
					</div>
				</div>
				<div class="form-group row">
					<label for="Nombre" class="col-sm-2 col-form-label">N° celular:</label>
					<div class="col-sm-4">
						<input type="number" class="form-control" placeholder="Número de celular" name="ccelular" onwheel="this.blur()" value="{{$persona[0]->ctelefono}}">
					</div>
					<label for="Nombre" class="col-sm-2 col-form-label">N° teléfono:</label>
					<div class="col-sm-4">
						<input type="number" class="form-control" placeholder="Número de teléfono" name="ctelefono" onwheel="this.blur()" value="{{$persona[0]->ccelular}}">
					</div>
				</div>
				<div class="form-group row">
					<label for="Nombre" class="col-sm-2 col-form-label">* Dirección:</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" placeholder="Calle N° 000" name="cdomicilio" style="text-transform: uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" required="" value="{{$persona[0]->cdomicilio}}">
					</div>
				</div>
				<div class="form-group row">
					<label for="Nombre" class="col-sm-2 col-form-label">Referencia:</label>
					<div class="col-sm-4">
						<input type="text" class="form-control" placeholder="Referencia" name="creferencia" style="text-transform: uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" value="{{$persona[0]->creferencia}}">
					</div>
					<label for="Nombre" class="col-sm-2 col-form-label">* Ciudad:</label>
					<div class="col-sm-4">
						<input type="text" class="form-control" placeholder="Nombre de la Ciudad" name="ciudad" style="text-transform: uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" required="" value="{{$persona[0]->cciudad}}">
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-4">
						<input type="email" class="form-control" placeholder="Correo personal" name="ccorreo" value="{{$persona[0]->ccorreo}}">
					</div>
				</div>
				...
				<br>
				<input type="hidden" name="nid_docpersona" value="{{$persona[0]->nid_docpersona}}">
				<input type="hidden" name="idusuario" value="{{$persona[0]->nid_usuario}}">
				<div class="row">
					<div class="offset-sm-5 col-sm-2">
						<button type="submit" class="btn" style="background: #B90D0D;color: #FFFFFF"><i class="far fa-save"></i> ACTUALIZAR</button>
					</div>
				</div>
