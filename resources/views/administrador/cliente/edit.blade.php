    ...
    <div class="card-header" id="headingOne" style="padding: 0px;box-shadow: 0 -2px 0px 0px rgba(115,115,115,0.4);">
      <div style="padding: 10px">
        <div style="float: left;color: #7B7B7B">
          ...
          <span><a href="{{URL::to('administrador/cliente')}}">Cliente</a></span> /
          <span>Editar</span>
        </div>
...
<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
  <div class="card-body" style="border-bottom: 1px solid #C0C0C0">
	...
	<div class="row">
	  <div class="col-md-6">
	      <h4 style="margin-top: 0px"><i class="fas fa-user-edit"></i> Editar Cliente</h4>
	   </div>
	</div>
...
{!!Form::model($persona,['method'=>'PATCH','action'=>['Administrador\ClienteController@update',$persona[0]->nid_persona],'files'=>true,'class'=>'formcreate'])!!}
            {{Form::token()}}
