...
<div class="row">
  <div class="col-md-6">
      <h4 style="margin-top: 0px"><i class="fas fa-user-edit"></i> Registrar Cliente</h4>
   </div>
</div>
...
<div class="row">
  ...
  {!!Form::open(array('url'=>'administrador/cliente','method'=>'POST','autocomplete'=>'off','files'=>true,'class'=>'formcreate'))!!}
            {{Form::token()}}
            	<div class="form-group row">
					...
					<div class="col-sm-4">
						<select name="personeria" id="selpersoneria" class="form-control">
							<?php for($i=0;$i<sizeof($personeria);$i++){
								?>
							<option value="{{$personeria[$i]->nvalor}}">{{$personeria[$i]->cdescripcion}}</option>
								<?php
							}?>
						</select>
					</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="email" class="form-control" placeholder="correo@personal.com" name="ccorreo">
					</div>
