...
<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
  ...
  <div class="row">
    <div class="col-md-6">
        <h4 style="margin-top: 0px"><i class="fas fa-user-edit"></i> Detalle Cliente &nbsp;&nbsp;<a href="{{URL::to('administrador/cliente/'.$persona[0]->nid_persona.'/edit')}}" style="font-size: 11pt">Editar</a></h4>
     </div>
  </div>
