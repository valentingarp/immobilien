...
<div class="row">
  <div class="col-md-6">
    <h3><strong style="border-bottom: 2px solid #D9D9DD;padding-bottom: 4px;">SERVICIO PROCESO</strong> <a href="" data-toggle="modal" data-target="#createservicio"><button class="btn btn-default bg-secondary" >Nuevo <i class="fas fa-plus-square"></i></button></a></h3>
  </div>
  <div class="col-md-6">
     <h3>@include('administrador.servicioproceso.search')</h3>
  </div>
</div>
<br>
...
<!--***********MODAL UPDATE*******-->
              ...
              {!!Form::model($servicio,['method'=>'PATCH','action'=>['Administrador\ServicioProcesoController@update',$servicio[$i]->nid_servicio],'class'=>'form-horizontal'])!!}
                    {{Form::token()}}
            ...
            <!--***********FIN****MODAL UPDATE*******-->
              ...
              <!--*****************MODAL ELIMINAR*************-->
                ...
                {{Form::Open(array('action'=>array('Administrador\ServicioProcesoController@destroy',$servicio[$i]->nid_servicio),'method'=>'delete'))}}
...
<div class="modal fade" id="createservicio" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
   {!!Form::open(array('url'=>'administrador/servicioproceso','method'=>'POST','autocomplete'=>'off'))!!}
  {{Form::token()}}
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-secondary" >
